...
class Superwar {
  ...
  fight = () => {
    ...
    setTimeout(() => this.announceWinner(finalscore), 100);
  ...
  calculateScore = () => {
    ...
    let winner = this.winnerInfo()
    let score = this.score
    // let board = { hero: 0, villain: 0 };
  ...
  winnerInfo = () => {
    let board = { hero: 0, villain: 0, draw: 0 }
  ...
  checkWin = () => {
    ...
    let result =
    this.totalStrength("hero") == this.totalStrength("villain") ?
    "endure" :
    this.totalStrength("hero") > this.totalStrength("villain") ?
    "hero" : "villain"
